...
train_pipeline = [
    ...
    dict(type='AutoAugment',
         policies=[
             [
                 dict(type='Resize',
                      # 755, 787, 819, 851, 883, 915, 947, 979, 1011, 1043, 1075,
                      img_scale=[(755, 2100), (787, 2100), (819, 2100), (851, 2100),
                                 (883, 2100), (915, 2100), (947, 2100), (979, 2100),
                                 (1011, 2100), (1043, 2100), (1075, 2100)],
                      multiscale_mode='value',
                      keep_ratio=True)
             ],
             [
                 dict(type='Resize',
                      img_scale=[(720, 2100), (820, 2100), (920, 2100)], # similar
                      multiscale_mode='value',
                      keep_ratio=True),
